...
import frames.rnbp_rpf_transformations_coeff as rnbp_rpf_transformations
...
t = et2
dist = rnp_rpf_coeff.get_distance(t_vec, mu_p, mu_s, naif_id_p, naif_id_s, ref_frame, abcorr_flag)
...
tau_vec, t_vec = rnp_rpf_coeff.compute_time(tau_vec_input, t0, epoch_time, mu_p, mu_s, naif_id_p, naif_id_s, ref_frame, ode_rtol = ode_rtol, ode_atol = ode_atol, abcorr_flag = abcorr_flag)
t_vec_days = t_vec / 86400

_, _, l_vec = rnp_rpf_coeff.compute_time_distance(tau_vec_input, t0, epoch_time, mu_p, mu_s, naif_id_p, naif_id_s, ref_frame, ode_rtol = ode_rtol, ode_atol = ode_atol, abcorr_flag = abcorr_flag)

tau_int, t_int = rnp_rpf_coeff.compute_time([tau_0, tau_f], t0, epoch_time, mu_p, mu_s, naif_id_p, naif_id_s, ref_frame, ode_rtol = ode_rtol, ode_atol = ode_atol, abcorr_flag = abcorr_flag)
...
tau = 53.678
# tau = 25
_, t_int_tau = rnp_rpf_coeff.compute_time([tau_0, tau], t0, epoch_time, mu_p, mu_s, naif_id_p, naif_id_s, ref_frame, ode_rtol = ode_rtol, ode_atol = ode_atol, abcorr_flag = abcorr_flag)
...
t0 = 0.0
epoch_time = et2
t_vec_v2, tau_vec_v2 = rnp_rpf_coeff.compute_tau(t_vec, tau_0, epoch_time, mu_p, mu_s, naif_id_p, naif_id_s, ref_frame, ode_rtol = ode_rtol, ode_atol = ode_atol, abcorr_flag = abcorr_flag)
...
t_vec_v3, tau_vec_v3 = rnp_rpf_coeff.compute_tau([t_vec[0], t_vec[-1]], tau_0, epoch_time, mu_p, mu_s, naif_id_p, naif_id_s, ref_frame, ode_rtol = ode_rtol, ode_atol = ode_atol, abcorr_flag = abcorr_flag)
...
t_vec, tau_vec, distance_vec = rnp_rpf_coeff.compute_tau_distance(t_vec, tau0, ep0, mu_p, mu_s, naif_id_p, naif_id_s, ref_frame, ode_rtol = ode_rtol, ode_atol = ode_atol, abcorr_flag = abcorr_flag)
...
# sol_prop_syn = propagate_ode(rnp_rpf_coeff.dynamics_coeff_eom, XF_0[0], tau_linspace, rnbprpf_dict_v2, ode_rtol, ode_atol)
sol_prop_syn = propagate_ode(rnp_rpf_coeff.dynamics_coeff_table, XF_0[0], tau_linspace, rnbprpf_dict_v2, ode_rtol, ode_atol)

# sol_prop_syn = propagate_ode(rnbprpf_dynamics, XF_0[0], tau_linspace, rnbprpf_dict)
# sol_prop_syn = propagate_ivp(rnp_rpf_coeff.dynamics_coeff_eom, XF_0[0], tau_linspace, rnbprpf_dict_v2, ode_rtol, ode_atol)
