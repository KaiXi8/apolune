...
"""
def frame_rnbprpf_transform(id_primary, id_secondary, pos_bodies, vel_bodies, num_bodies, mu_bodies, LU, VU):
...
def inertialToSynodic(time, state_inertial, rnbprpf_dict):
    ...
    pos_bodies_all /= LU # [adim]
    vel_bodies_all /= VU # [adim]
    ...
    for i in range(num_time):
        ...
        b, b1d, k, k1d, C, C1d = frame_rnbprpf_transform(id_primary, id_secondary, pos_bodies, vel_bodies, num_bodies, mu_bodies, LU, VU)
