...
import scp.scp_solve_low_thrust as scp_solve
...
x0 = np.array([0.870183, -0.059444, 0, -0.010471, -0.175136, 0, 0]) # adim
...
# jacobian_u_function = dyn_coeff.jacobian
...
# time_days = np.linspace(t0, tf_dim_days, N)
...
scaling_dict = {'LU': LU, 'VU': VU, 'TU': TU, 'ACU': ACU, 'FU': FU}
...
auxdata['param']['time_vec'] = time
# auxdata['param']['time_vec'] = time_days
